...
2022年1月東京エレクトロンへ転職。AI応用を担う部署にて画像解析の自動化や装置機能開発などに従事の後、内製アプリケーションの社内向けカスタマーサクセスを立ち上げ推進。また、AI利活用戦略を企画し推進。
データ解析の社内コミュニティ立ち上げ、社内ラジオ配信、SaaS導入、ソフトウェアベンダーの開発管理など実施中（2025年12月現在）
